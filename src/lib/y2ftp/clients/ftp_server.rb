  ...
  module Clients
    ...
    class FtpServer < Yast::Client
      ...
      def run
        ...
        Yast::Builtins.y2milestone("[ftp-server] module started")
        ...
        @cmdline_description = {
          ...
          "initialize" => fun_ref(Yast::FtpServer.method(:Read), "boolean ()"),
        ...
        if Yast::Ops.greater_than(Yast::Builtins.size(@args), 0)
          if Yast::Ops.is_path?(Yast::WFM.Args(0)) && Yast::WFM.Args(0) == path(".propose")
            Yast::Builtins.y2milestone("[ftp-server] Using PROPOSE mode")
            @propose = true
          end
        end
        ...
        # Finish
        Yast::Builtins.y2milestone("[ftp-server] module finished")
        Yast::Builtins.y2milestone("----------------------------------------")
      ...
      def FTPdCMDShow(_options)
        ...
        if Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "VerboseLogging") == "YES"
        ...
        if Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "ChrootEnable") == "YES"
          CommandLine.Print(_("Enable"))
          # CommandLine::Print("");
        else
          CommandLine.Print(_("Disable"))
        ...
        # UMASK settings
        if Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "UmaskAnon") != ""
          CommandLine.PrintNoCR(_("Umask for Anonymous: "))
          CommandLine.Print(Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "UmaskAnon"))
        else
          CommandLine.PrintNoCR(_("Umask for Anonymous:"))
          CommandLine.Print(_("Option is not set now."))
        end
        if Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "UmaskLocal") != ""
          CommandLine.PrintNoCR(_("Umask for Authenticated Users: "))
          CommandLine.Print(Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "UmaskLocal"))
          # CommandLine::Print("");
        else
          CommandLine.PrintNoCR(_("Umask for Authenticated Users: "))
          CommandLine.Print(_("Option is not set now."))
        ...
        if Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "FtpDirLocal") != ""
          CommandLine.Print(Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "FtpDirLocal"))
        else
          CommandLine.Print(_("Option is not set now."))
        end

        CommandLine.PrintNoCR(_("Anonymous dir: "))
        if Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "FtpDirAnon") != ""
          CommandLine.Print(Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "FtpDirAnon"))
        else
          CommandLine.Print(_("Option is not set now."))
        end
        # port range
        CommandLine.PrintNoCR(_("Port Range: "))
        if Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "PasMaxPort") != "0"
          CommandLine.PrintNoCR(Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "PasMinPort"))
          CommandLine.PrintNoCR(_(" - "))
          CommandLine.Print(Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "PasMaxPort"))
        else
          CommandLine.Print(_("Option is not set now."))
        end
        ...
        if Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "MaxIdleTime") != "0"
          CommandLine.Print(Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "MaxIdleTime"))
        else
          CommandLine.Print(_("Option is not set now."))
        end
        ...
        if Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "MaxClientsPerIP") != "0"
          CommandLine.Print(Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "MaxClientsPerIP"))
        else
          CommandLine.Print(_("Option is not set now."))
        end
        ...
        if Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "MaxClientsNumber") != "0"
          CommandLine.Print(Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "MaxClientsNumber"))
        else
          CommandLine.Print(_("Option is not set now."))
        end
        ...
        if Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "LocalMaxRate") != "0"
          CommandLine.Print(Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "LocalMaxRate"))
        else
          CommandLine.Print(_("Option is not set now."))
        end
        ...
        if Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "AnonMaxRate") != "0"
          CommandLine.Print(Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "AnonMaxRate"))
        else
          CommandLine.Print(_("Option is not set now."))
        end
        ...
        if Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "AnonReadOnly") == "NO"
          CommandLine.PrintNoCR(_("Upload enabled; "))
        else
          CommandLine.PrintNoCR(_("Upload disabled; "))
        end
        if Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "AnonCreatDirs") == "YES"
        ...
        if Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "Banner") != ""
          CommandLine.Print(Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "Banner"))
        else
          CommandLine.Print(_("Option is not set now."))
        end
        ...
        if Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "SSLEnable") != "YES"
          CommandLine.Print(_("SSL is disabled"))
        else
          CommandLine.Print(_("SSL is enabled"))
        end

        if Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "TLS") != "YES"
      ...
      def FTPdCMDStartup(options)
        ...
        if !Yast::Ops.get(options, "atboot").nil? && !Yast::Ops.get(options, "manual").nil?
          # TRANSLATORS: CommandLine error message
          CommandLine.Error(_("Only one parameter (atboot/manual) is allowed."))
        elsif !Yast::Ops.get(options, "atboot").nil?
          CommandLine.Print("")
        ...
        elsif !Yast::Ops.get(options, "manual").nil?
          CommandLine.Print("")
          # TRANSLATORS: CommandLine header
          CommandLine.Print(String.UnderlinedHeader(_("Start-Up:"), 0))
          CommandLine.Print("")
        ...
        elsif !Yast::Ops.get(options, "socket").nil?
          CommandLine.Print("")
          # TRANSLATORS: CommandLine header
          CommandLine.Print(String.UnderlinedHeader(_("Start-Up:"), 0))
          CommandLine.Print("")
      ...
      def FTPdCMDLogging(options)
        options = deep_copy(options)
        if Yast::Ops.greater_than(Yast::Builtins.size(options), 1)
          # TRANSLATORS: CommandLine error message
          CommandLine.Error(_("Only one parameter (enable/disable) is allowed."))
        elsif !Yast::Ops.get(options, "enable").nil?
          Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, "VerboseLogging", "YES")
        elsif !Yast::Ops.get(options, "disable").nil?
          Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, "VerboseLogging", "NO")
      ...
      def FTPdCMDChrooting(options)
        ...
        if Yast::Ops.greater_than(Yast::Builtins.size(options), 1)
          ...
          Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, "ChrootEnable", "YES")
        elsif !Yast::Ops.get(options, "disable").nil?
          Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, "ChrootEnable", "NO")
        end # end of else if (options["show"]:nil!=nil
      ...
      def FTPdCMDUmask(options)
        ...
        if Yast::Ops.greater_than(Yast::Builtins.size(options), 1)
          ...
          if !Yast::Ops.get(options, "set_umask").nil?
            value = Yast::Ops.get_string(options, "set_umask")
            value = Yast::Builtins.filterchars(value, "01234567:")
            if value != ""
              temp = Yast::Builtins.splitstring(value, ":")
              if Yast::Ops.greater_than(Yast::Builtins.size(temp), 1)
                CommandLine.PrintNoCR(_("Umask for Anonymous: "))
                CommandLine.Print(Yast::Ops.get(temp, 0))
                CommandLine.PrintNoCR(_("Umask for Authenticated Users: "))
                CommandLine.Print(Yast::Ops.get(temp, 1))
                CommandLine.Print("")
                Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, "UmaskAnon", Yast::Ops.get(temp, 0))
                Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, "UmaskLocal", Yast::Ops.get(temp, 1))
              else
      ...
      def FTPdCMDAnonDir(options)
        ...
        CommandLine.Print("")
        if Yast::Builtins.size(options) == 1
          if !Yast::Ops.get(options, "set_anon_dir").nil?
            value = Yast::Ops.get_string(options, "set_anon_dir")
            if !value.nil?
              CommandLine.PrintNoCR(_("Anonymous directory:"))
              CommandLine.Print(value)
              CommandLine.Print("")
              Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, "FtpDirAnon", value)
            else
      ...
      def FTPdCMDPassPorts(options)
        ...
        CommandLine.Print("")
        if Yast::Builtins.size(options) == 2
          min_port = Yast::Ops.get_integer(options, "set_min_port")
          max_port = Yast::Ops.get_integer(options, "set_max_port")
          if !min_port.nil? && !max_port.nil?
            if Yast::Ops.less_or_equal(min_port, max_port) &&
                Yast::Ops.greater_than(max_port, 0)
              Yast::Ops.set(
                Yast::FtpServer.EDIT_SETTINGS,
                "PasMinPort",
                Yast::Builtins.tostring(min_port)
              )
              Yast::Ops.set(
                Yast::FtpServer.EDIT_SETTINGS,
                "PasMaxPort",
                Yast::Builtins.tostring(max_port)
              )
              CommandLine.PrintNoCR(_("Port range for passive mode: "))
              CommandLine.PrintNoCR(
                Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "PasMinPort")
              )
              CommandLine.PrintNoCR(_(" - "))
              CommandLine.Print(Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "PasMaxPort"))
            else
      ...
      def CommonHandler(options, str_key_option, map_key, underline_text, result_text)
        ...
        CommandLine.Print("")
        if Yast::Builtins.size(options) == 1
          result = Yast::Ops.get_integer(options, str_key_option)
          if !result.nil?
            Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, map_key, Yast::Builtins.tostring(result))
            CommandLine.PrintNoCR(result_text)
            CommandLine.Print(Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, map_key))
            CommandLine.Print("")
            return true
          else
            # TRANSLATORS: CommandLine error message
      ...
      def FTPdCMDAccess(options)
        ...
        if Yast::Builtins.size(options) == 1
          CommandLine.PrintNoCR(_("Access allowed for: "))
          if !Yast::Ops.get(options, "anon_only").nil?
            Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, "AnonAuthen", "0")
            CommandLine.PrintNoCR(_("Anonymous users"))
          elsif !Yast::Ops.get(options, "authen_only").nil?
            Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, "AnonAuthen", "1")
            CommandLine.PrintNoCR(_("Authenticated users"))
          elsif !Yast::Ops.get(options, "anon_and_authen").nil?
            Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, "AnonAuthen", "2")
      ...
      def FTPdCMDAnonAccess(options)
        ...
        CommandLine.Print("")
        if Yast::Ops.greater_than(Yast::Builtins.size(options), 0) &&
            Yast::Ops.less_or_equal(Yast::Builtins.size(options), 2)
          if !Yast::Ops.get(options, "can_upload").nil?
            Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, "AnonReadOnly", "NO")
            CommandLine.PrintNoCR(_("Upload enabled"))
          else
            Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, "AnonReadOnly", "YES")
            CommandLine.PrintNoCR(_("Upload disabled"))
          end
          CommandLine.PrintNoCR(_("; "))
          if !Yast::Ops.get(options, "create_dirs").nil?
            Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, "AnonCreatDirs", "YES")
            CommandLine.PrintNoCR(_("Create dirs enabled"))
          else
            Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, "AnonCreatDirs", "NO")
      ...
      def FTPdCMDWelMessage(options)
        ...
        if Yast::Builtins.size(options) == 1
          if !Yast::Ops.get(options, "set_message").nil?
            Yast::Ops.set(
              Yast::FtpServer.EDIT_SETTINGS,
              "Banner",
              Yast::Ops.get_string(options, "set_message")
            )
            CommandLine.Print(Yast::Ops.get(Yast::FtpServer.EDIT_SETTINGS, "Banner"))
            return true
          else
      ...
      def CommonHandlerCheckBox(options, header, _vsftpd_deamon, name_option_EDIT_SETTINGS, general_name)
        ...
        CommandLine.Print("")
        if Yast::Builtins.size(options) == 1
          if !Yast::Ops.get(options, "enable").nil?
            Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, name_option_EDIT_SETTINGS, "YES")
            general_name = Yast::Ops.add(general_name, " is enabled")
            CommandLine.Print(general_name)
            CommandLine.Print("")
            return true
          elsif !Yast::Ops.get(options, "disable").nil?
            Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, name_option_EDIT_SETTINGS, "NO")
            general_name = Yast::Ops.add(general_name, " is disabled")
            CommandLine.Print(general_name)
            CommandLine.Print("")
          else
            # TRANSLATORS: CommandLine error message
          ...
          CommandLine.Error(_("Only one parameter is allowed."))
          CommandLine.Print("")
          name_option_EDIT_SETTINGS = Yast::Ops.add(
            Yast::Ops.add("Example of correct using: ", name_option_EDIT_SETTINGS),
            " enable/disable"
          )
      ...
      def FTPdCMDSSL_TLS(options)
        ...
        if Yast::Builtins.size(options) == 1
          if !Yast::Ops.get(options, "enable").nil?
            Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, "SSL", "0")
            CommandLine.Print(_("SSL and TLS are enabled"))
            CommandLine.Print("")
            return true
          elsif !Yast::Ops.get(options, "disable").nil?
            Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, "SSL", "1")
            CommandLine.Print(_("SSL and TLS are disabled"))
            CommandLine.Print("")
          elsif !Yast::Ops.get(options, "only").nil?
            Yast::Ops.set(Yast::FtpServer.EDIT_SETTINGS, "SSL", "2")
